...
#define CTRL5_INT_PAD_CRL_VALUE_DATA_READY                      (0x01)		
...
#define FIFO_CTRL_START     				(4 << 5) | (25)              				// first part to stop the fifo | threshold values in buffer how many it should be
#define TRESHOLD_VALUE_MG                   		(2550)  						// threshold value in mg
...
#define Y_POSITION						1
#define Z_POSITION						0
#define EXTRA_VALUES_TO_SEND                                    2
#define CONVERT_G_TO_MG						1000
#define X_OFS_USR_VALUE						0xFF
#define Y_OFS_USR_VALUE						0xFE
#define Y2_OFS_USR_VALUE					0x40
#define Z_OFS_USR_VALUE						0xC0


#define MeanValueEnable                                         1
#define MeanValueX                                              (-37.3497)
#define MeanValueY                                              (-9.12890)
#define MeanValueZ                                              (25.90540)
...
#define QUANT_VAL_2g                                            63
#define QUANT_VAL_4g                                            125
#define QUANT_VAL_8g                                            250
#define QUANT_VAL_16g                                           500
...
#define STEVAL_MKI1178V1_CS_PIN            		24   //  chip select pin 1: I2C active 0: SPI active
#define STEVAL_MKI1178V1_SA0_PIN            		25   //  last bit value of the  slave address in 2C
...
typedef enum
{
    ACCEL_EVT_NOT_IN_USED                             /**< Not in use: is meant for propagation a event to the main*/
...
typedef struct
{
  // 3 floats where 1. is z, 2. is y, 3. is x --> because of the wake_up_src
  float values[3]; 
} Accel_data_p_t;
...
static double dt_values[][2] =  
 ...
 // this look-up table is defined from datasheet table  
static double calculation_values[][2] =  
...
int MKI1178V1_read_treshold(uint8_t* data);
